...
class Neo4jIngestion:
    ...
    def validate_article_data(self, article_data: Dict[str, Any]) -> bool:
        ...
        Args:
            article_data: Dict containing article and stock_symbol
    ...
    def ingest_batch(self, articles_data: List[Dict[str, Any]], batch_size: int = 50) -> Dict[str, int]:
        """
        Ingest articles in batches with validation.

        Args:
            articles_data: List of article dictionaries
            batch_size: Number of articles to process at once (increased to 50 for GDELT)
